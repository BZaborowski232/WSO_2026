...
import pl.edu.pw.wso.algorithms.MinMinAllocator;
...
public class MinMinExperiment {

    public static void main(String[] args) {
        String variant = (args.length > 0) ? args[0] : "A";
        int taskCount = (args.length > 1) ? Integer.parseInt(args[1]) : 500;

        System.out.println("Rozpoczynam MinMin | Wariant: " + variant + " | Zadania: " + taskCount);
        ...
        try {
            ...
            DatacenterBroker broker = new DatacenterBroker("Broker_MinMin");
            ...
            // Algorytm Min-Min
            MinMinAllocator.allocate(broker, cloudletList, vmlist);
            ...
            CsvExporter.exportEnergyToCsv("MinMin", variant, taskCount, energyKWh, "DATA/energia_MinMin_" + variant + "_" + taskCount + ".csv");

            List<Cloudlet> newList = broker.getCloudletReceivedList();
            printCloudletList(newList);
            CsvExporter.exportCloudletsToCsv(newList, "DATA/wyniki_MinMin_" + variant + "_" + taskCount + ".csv");
